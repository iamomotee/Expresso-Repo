...
arpu = joblib.load('ARPU_SEGMENTscaler.pkl')
data_vol = joblib.load('DATA_VOLUMEscaler.pkl')
montant = joblib.load('MONTANTscaler.pkl')
mrg = joblib.load('MRG_encoder.pkl')
revenue = joblib.load('REVENUEscaler.pkl')
